...
public class ProducerRepository {
    public static void save(Producer producer) {
        ...
        try (Connection conn = ConnectionFactory.getConnection();
            ...
            log.error("Error hile trying to insert producer {}", producer.getName(), e);
        }
    }
    ...
    private static void preparedStatementSaveTransaction(Connection connection, List<Producer> producers) throws SQLException {
        ...
        for (Producer p : producers) {
            try (PreparedStatement ps = connection.prepareStatement(sql)) {
                ...
                ps.execute();
//                if (p.getName().equalsIgnoreCase("White fox")) throw new SQLException("Can´t save white fox");
            } catch (SQLException e) {
                e.printStackTrace();
                shouldRollBack = true;
            }
    ...
    private static CallableStatement callableStatementFindByName(Connection connection, String name) throws SQLException {
        String sql = "CALL `anime_store`.`sp_get_procedure_by_name`(?);";
    ...
    public static void showProducerMetaData() {
        log.info("Showing Producers Metadate");
    ...
    public static void showTypeScrollWorking() {
        ...
        try (Connection conn = ConnectionFactory.getConnection();
            ...
            log.info("----------");
            rs.next();
            log.info("is afterLast? '{}'", rs.isAfterLast());
            while (rs.previous()) {
                log.info(Producer.builder().id(rs.getInt("id")).name(rs.getString("name")).build());
